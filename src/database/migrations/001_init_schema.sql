-- ============================================================================
-- LexAI Perú - Migración Inicial: Schema de Base de Datos
-- Número: 001
-- Descripción: Crea todas las tablas, índices, vistas y funciones necesarias
-- ============================================================================
...
DROP TRIGGER IF EXISTS tr_actualizar_actividad_en_consulta ON consultas;
CREATE TRIGGER tr_actualizar_actividad_en_consulta
AFTER INSERT ON consultas
FOR EACH ROW
EXECUTE FUNCTION actualizar_ultima_actividad();

DROP TRIGGER IF EXISTS tr_actualizar_actividad_en_pago ON pagos;
