 ...
 */
export function esTeléfonoPeruanoValido(telefono: string): boolean {
 ...
 */
export function normalizarTeléfonoPeruano(telefono: string): string | null {
  if (!telefono) {
    return null;
  }
 ...
 */
export function sonIguales(valor1: string, valor2: string): boolean {
 ...
 */
export function extraerDominioEmail(email: string): string | null {
 ...
 */
export function esEmailTemporal(email: string): boolean {
